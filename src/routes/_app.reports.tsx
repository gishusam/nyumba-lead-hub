...
function ReportsPage() {
  ...
  const [fetchNarrative, setFetchNarrative] = useState(false);
        ...
        {!fetchNarrative ? (
          <div className="flex flex-col items-center gap-3 py-4">
            <div className="inline-flex items-center gap-2 text-muted-foreground text-sm">
              ...
              AI-generated narrative of this week's pipeline activity
            </div>
            <Button
              size="sm"
              onClick={() => setFetchNarrative(true)}
          ...
          <>
            ...
            <div className="absolute bottom-2 right-3 inline-flex items-center gap-1 text-[11px] text-muted-foreground">
              <Sparkles className="h-3 w-3" /> Generated by Groq AI
            </div>
          </>
        ) : (
          <div className="flex flex-col items-center gap-3 py-2">
            <p className="text-sm text-muted-foreground italic">
              No narrative available — the AI may still be processing this week's data.
            </p>
            <Button
              variant="outline"
              size="sm"
              onClick={() => narrativeQ.refetch()}
              disabled={narrativeQ.isFetching}
            >
              {narrativeQ.isFetching ? (
                <Loader2 className="h-4 w-4 mr-1.5 animate-spin" />
              ) : (
                <RefreshCw className="h-4 w-4 mr-1.5" />
              )}
